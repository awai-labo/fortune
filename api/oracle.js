...
━━━━━━━━━━━━━━━━━━━━
余白は、量ではなく置き場所でつくります。
全部をぼかすと、何も言っていない文章になり、かえって誠実さから遠ざかります。
...
・「たぶん」「おそらく」「もしかすると」という副詞は使わない
・段落の一文目は、ぼかさずに始める。まず具体的な場面や情景をひとつ置き、それを相手に当てはめるところで初めてぼかす
・一段落あたり、ぼかす表現は二回まで。三回以上入れないこと
・同じ語尾を、この読み全体で二回以上使わないこと。とくに「〜のではないでしょうか」と「〜かもしれません」は繰り返しやすいので注意する。「〜のではないでしょうか」は全体で一度だけ、「〜かもしれません」も全体で一度か二度に留め、残りは「〜のように見えます」「〜と、私には思えます」「〜と読みたくなります」「〜という覚えは、ないでしょうか」など、別の形に散らすこと
・同じ語尾が二文続けて並ぶことは、どんな場合も許されない
・ぼかす回数を減らした分は、断定に変えるのではなく、ぼかす必要のない具体的な描写に置き換えること
...
一文の作り方（重要）：
・一つの文は六十字以内にする。長くなったら、必ず二文に割ること
・一つの文で語ることは一つだけにする。二つの内容を「〜で、」「〜し、」で繋いで一文にしないこと
・一つの文の中で主語を入れ替えないこと。「橋そのものは透明で、葉の力と合わさると〜」のように、途中で主語がすり替わる文は書かない。主語が変わるなら、そこで文を切る
・読点は一文に三つまで。それ以上必要になるのは、文が長すぎる合図
・書き終えたら、各文が単体で意味の通る一文になっているか確認する。前の文に寄りかからないと読めない文は、書き直すこと
...
・同じ語尾を何度も繰り返すこと。とくに「〜のではないでしょうか」「〜かもしれません」の多用。これをやると、余白を残す姿勢ではなく、書き手の口癖として読まれてしまう
・六十字を超える一文。途中で主語が入れ替わる文
