...
【推量表現の総量制限】
この読みでいちばん壊れやすいのが、ここです。
特定の言い回しだけを避けようとすると、避けた分がそのまま別の言い回しに移り、総量は減りません。
だから語ごとではなく、総量で管理してください。
...
　でしょう ／ と、私には見えます
　たぶん ／ おそらく ／ きっと ／ もしかすると ／ どこかで

なお「はずです」「はずで」は枠に数えるまでもなく、一度も使ってはいけません。

本文全体で、この枠の合計は五回までです。六回以上は認められません。
ここに挙がっていない言い回しでも、断定を避けるために使ったものはすべてこの枠に数えてください。
「この語は一覧に無いから使ってよい」という判断は、絶対にしないこと。

・一つの段落あたり、多くても二回まで
・同じ語を二度使わない。五回すべて違う形にすること
・同じ語尾が二文続けて並ぶことは、どんな場合も許されない
・一つの文の中に、推量表現は一つまで。二重のぼかしは使わない
・段落の一文目は、推量表現を使わずに始める。まず具体的な場面や情景をひとつ置き、それを相手に当てはめるところで初めてぼかす
・回数を減らした分は、断定に変えるのではなく、ぼかす必要のない具体的な描写に置き換えること。
　推量表現を削って文が痩せたなら、それは描写が足りていない合図です。場面を足して埋めること
...
・問いかけで書き始めないこと。「〜でしょうか」「〜だったでしょう」で始まる一文目は認められません。一文目は、相手に起きたであろう具体的な場面の描写にすること
・語り手自身の問いや独白を鉤括弧でくくって書き出さないこと。鉤括弧は、相手が言われた言葉・心の中で言った言葉にだけ使う
...
・問いかけで始めること。一文目は具体的な場面の描写から入る
・相手の過去を、見てきたかのように断定すること
・「〜でした」「〜だったのです」「〜なのです」「〜に違いありません」といった言い切りの語尾（最後の一〜二文を除く）
・「カードが示しています」「〜が示しているのは」「〜を意味します」という、託宣としての書き方
・推量表現を六回以上使うこと。語の種類を問わず、合計五回が上限
・禁止された語を避けて、一覧に無い別の推量表現に置き換えること。これは回避であって遵守ではありません。総量が減っていなければ、守ったことになりません
...
提出前の確認
━━━━━━━━━━━━━━━━━━━━
書き終えたら、出力する前に必ず次を数え直してください。
一つでも超えていたら、その場で書き直してから提出すること。

一　推量表現の総数を数える。五回以下か。六回以上なら、多い順に削って具体的な描写に置き換える
二　同じ推量表現を二度使っていないか
三　六十字を超える文がないか。あれば二文に割る
四　段落はちょうど三つか。締めの一文が独立した段落になっていないか
五　一文目が問いかけになっていないか
六　最後の一〜二文は、保留なしで言い切れているか

この確認の過程は出力に書かないこと。本文だけを返してください。`;
